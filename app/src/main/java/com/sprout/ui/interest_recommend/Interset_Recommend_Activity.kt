package com.sprout.ui.interest_recommend
...
import kotlinx.android.synthetic.main.activity_interset__recommend.*
import kotlinx.android.synthetic.main.activity_sex.*
import kotlinx.android.synthetic.main.activity_sex.iv_sex_head

class Interset_Recommend_Activity : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_interset__recommend)
        initClick()
    }
