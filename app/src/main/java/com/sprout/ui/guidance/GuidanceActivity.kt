...
class GuidanceActivity : AppCompatActivity() {
    ...
    override fun onWindowFocusChanged(hasFocus: Boolean) {
        ...
        val guidance = SpUtils.instance!!.getString("guidance")
        initTimerRe()
...
//        }
    ...
    private fun initPw() {
        ...
        val popupView: View = LayoutInflater.from(this@GuidanceActivity).inflate(R.layout.layout_guidance_pop, null)
        //设置popu
    ...
    fun initText(popupView: View) {
        ...
        spannableString.setSpan(ForegroundColorSpan(Color.parseColor("#80A55F")),
    ...
    //倒计时注册
    private fun initTimerRe() {
//        Observable.intervalRange(0,1,0,1,TimeUnit.SECONDS)
//            .observeOn(AndroidSchedulers.mainThread())
//            .subscribe {
//                val l = it - 1
//                if (l == 0L) {
//                    startActivity(Intent(this@GuidanceActivity, RegisterActivity::class.java))
//                    finish()
//
//
//                }
